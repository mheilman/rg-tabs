...
riot.tag('rg-tabs', '<div class="tabs"> <div class="headers"> <div each="{ tabs }" class="header { active: active, disabled: disabled }" onclick="{ parent.activate }"> <h4>{ opts.heading }</h4> </div> </div> <yield></yield> </div>', 'rg-tabs .tabs { background-color: white; } rg-tabs .headers { display: flex; } rg-tabs .header { flex: 1; box-sizing: border-box; text-align: center; cursor: pointer; box-shadow: 0 -1px 0 0 #6495ED inset; } rg-tabs .header.active { background-color: #6495ED; color: white; } rg-tabs .header.disabled { color: grey; }', function (opts) {
	var _this = this;
